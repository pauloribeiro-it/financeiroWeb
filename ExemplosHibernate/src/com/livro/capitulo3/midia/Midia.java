...
public class Midia implements Serializable{
	...
	private static final long serialVersionUID = 4304455449750332702L;
	@Id
	@GeneratedValue
	...
	public final Integer getMidia() {
		return midia;
	}


	public final void setMidia(Integer midia) {
		this.midia = midia;
	}


	public final Filme getFilme() {
		return filme;
	}
	...
	public final String getInutilizada() {
		return inutilizada;
	}


	public final void setInutilizada(String inutilizada) {
